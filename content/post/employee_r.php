<?php
    ...
    if ($mode === 'create') {
        ...
        $sql = "INSERT INTO `employee_record` (employee_id, record_type, date_filed, reason, status, remarks, file_ticket) 
                VALUES ('$employee_id', '$record_type', '$date_filed', '$reason', '$status', '$remarks', '$file_ticket')";
